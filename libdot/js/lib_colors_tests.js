...
it('hexToRGB', () => {
  const data = [
    ...
    ['#000', 'rgb(0, 0, 0)'],
    ['#abc', 'rgb(170, 187, 204)'],
    ['#abcc', 'rgb(170, 187, 204, 0.8)'],
    ['#a0b0c0', 'rgb(160, 176, 192)'],
    ['#fFfFFf', 'rgb(255, 255, 255)'],
    ['#a0b0c000', 'rgb(160, 176, 192, 0)'],
    ['#a0b0c0cc', 'rgb(160, 176, 192, 0.8)'],
...
it('normalizeCSS', () => {
  const data = [
    ...
    ['hsla(24, 100%, 70%, 0.5)', 'rgb(255, 163, 102, 0.5)'],
  ];
...
it('arrayToRGB', () => {
  const data = [
    [[1, 2, 3], 'rgb(1, 2, 3)'],
    [[10, 200, 3, 0], 'rgb(10, 200, 3, 0)'],
    [['0', '30', '50', '1'], 'rgb(0, 30, 50)'],
    [['0', '30', '50', '0.5'], 'rgb(0, 30, 50, 0.5)'],
  ];

  data.forEach((ele) => {
    assert.strictEqual(lib.colors.arrayToRGB(ele[0]), ele[1], ele[0]);
  });
});
...
it('setAlpha', () => {
  const data = [
    [['rgb(2,3,4)', 0], 'rgb(2, 3, 4, 0)'],
    [['rgb(2,3,4)', 1], 'rgb(2, 3, 4)'],
    [['rgba(2,3,4, 0)', 0], 'rgb(2, 3, 4, 0)'],
    [['rgba(2,3,4, 0)', 1], 'rgb(2, 3, 4)'],
    [['rgba(2, 3, 4, 1)', 0], 'rgb(2, 3, 4, 0)'],
    [['rgba(2, 3, 4, 1)', 1], 'rgb(2, 3, 4)'],
    [['rgba(2, 3, 4, 1)', '0.5'], 'rgb(2, 3, 4, 0.5)'],
  ];
...
it('hslToRGB', () => {
  const data = [
    ...
    ['hsla(210, 20%, 69%, 0)', 'rgb(160, 176, 192, 0)'],
    ['hsla(210, 20%, 69%, 0.8)', 'rgb(160, 176, 192, 0.8)'],
