...
export class TransparencySliderElement extends LitElement {
  ...
  render() {
    return html`
        <div id="display" style="background-image: linear-gradient(to right, transparent, hsl(${this.hue}, 100%, 50%));">
        </div>
        <div id="picker" style="left: ${100 * this.transparency}%; background-color: hsl(${this.hue}, 100%, 50%);">
        </div>
    `;
  }
